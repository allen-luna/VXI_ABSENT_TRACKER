...
const Modal = ({ isOpen, onClose, onCreateRequest }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.date_request === "" || formData.category === "" || formData.start_shift === "" || formData.end_shift === "" || formData.contact_number === ""  ) {
      alert('Please fill in all the red outlined required fields.');
      return;
    }
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="mb-4 col-span-1">
                ...
                <input
                  className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                    formData.contact_number === "" ? "border-red-500" : ""
                  }`}
                  id="contact_number"
                  type="tel"
                  name="contact_number"
